...
enyo.path.addPaths({layout: "/var/www/enyo/fun_book/enyo/../lib/layout/", onyx: "/var/www/enyo/fun_book/enyo/../lib/onyx/", onyx: "/var/www/enyo/fun_book/enyo/../lib/onyx/source/"});
...
new enyo.kind({
name: "com.particles4dev.model.UserData",
published: {
user_id: -1,
...
getLeft: function() {
return this.owner.$.left;
},
getMainPanel: function() {
return this.owner.$.left.$.MainMenu;
},
getBody: function() {
return this.owner.$.body;
},
connect: function() {
var e = this.screen_name, t = new enyo.JsonpRequest({
url: "https://api.twitter.com/1/users/lookup.json",
callbackName: "callback"
});
t.response(enyo.bind(this, "identify")), t.go({
screen_name: e
});
},
identify: function(e, t) {
if (!t) return;
var n = this.getLeft(), r = this.getMainPanel();
this.id = t[0].id_str, this.screen_name = t[0].screen_name, this.picture = t[0].profile_image_url, r.changeAvatar(this.picture), r.changeUsername(this.screen_name), n.showToolbar(), this.getTweet();
},
getTweet: function() {
this.getBody().showLoading();
var e = new enyo.JsonpRequest({
url: "http://api.twitter.com/1/statuses/user_timeline.json",
callbackName: "callback"
});
e.response(enyo.bind(this, "processGetTweet")), e.go({
screen_name: this.screen_name,
include_rts: !0,
include_entities: !0
});
},
processGetTweet: function(e, t) {
if (!t) return;
this.getBody().addTweets(t), this.getBody().hideLoading();
}
});
...
$.browser.msie && (n = Date.parse(e.replace(/( \+)/, " UTC$1")));
var r = t - n, i = 1e3, s = i * 60, o = s * 60, u = o * 24, a = u * 7;
return isNaN(r) || r < 0 ? "" : r < i * 2 ? "right now" : r < s ? Math.floor(r / i) + " seconds ago" : r < s * 2 ? "about 1 minute ago" : r < o ? Math.floor(r / s) + " minutes ago" : r < o * 2 ? "about 1 hour ago" : r < u ? Math.floor(r / o) + " hours ago" : r > u && r < u * 2 ? "yesterday" : r < u * 365 ? Math.floor(r / u) + " days ago" : "over a year ago";
},
ify: {
link: function(e) {
return e.replace(/\b(((https*\:\/\/)|www\.)[^\"\']+?)(([!?,.\)]+)?(\s|$))/g, function(e, t, n, r, i) {
var s = n.match(/w/) ? "http://" : "";
return '<a class="twtr-hyperlink" target="_blank" href="' + s + t + '">' + (t.length > 25 ? t.substr(0, 24) + "..." : t) + "</a>" + i;
});
},
at: function(e) {
return e.replace(/\B[@\uff20]([a-zA-Z0-9_]{1,20})/g, function(e, t) {
return '<a target="_blank" class="twtr-atreply" href="http://twitter.com/intent/user?screen_name=' + t + '">@' + t + "</a>";
});
},
list: function(e) {
return e.replace(/\B[@\uff20]([a-zA-Z0-9_]{1,20}\/\w+)/g, function(e, t) {
return '<a target="_blank" class="twtr-atreply" href="http://twitter.com/' + t + '">@' + t + "</a>";
});
},
hash: function(e) {
return e.replace(/(^|\s+)#(\w+)/gi, function(e, t, n) {
return t + '<a target="_blank" class="twtr-hashtag" href="http://twitter.com/search?q=%23' + n + '">#' + n + "</a>";
});
},
clean: function(e) {
...
enyo.kind({
name: "com.particles4dev.Layout.Login",
classes: "menu-left",
layoutKind: "FittableRowsLayout",
components: [ {
name: "title",
...
kind: "onyx.Toolbar",
classes: "quick-search menu-frame",
style: "white-space: normal; border-left: none; padding: 7px 20px 7px 20px; width: 80%; margin: 40% auto 0 auto;",
components: [ {
kind: "onyx.InputDecorator",
classes: "border-box",
style: "",
...
getValue: function() {
return this.$.username.hasNode().value;
},
getDataModel: function() {
return this.owner.owner.$.data;
},
getLeftPanel: function() {
return this.owner;
},
login: function() {
var e = this.getValue(), t = this.getDataModel(), n = this.getLeftPanel();
e && e != "" && (n.showLoading(), t.setScreen_name(e), t.connect());
},
loginOnEnter: function(e, t) {
if (t.keyCode === 13) return this.login(), !0;
}
});
...
enyo.kind({
name: "com.particles4dev.Layout.Followers",
classes: "menu-left ",
layoutKind: "FittableRowsLayout",
components: [ {
kind: "onyx.Toolbar",
...
data: [ {
img: "http://farm9.static.flickr.com/8179/8056992162_af4992a032.jpg",
name: "maria"
}, {
img: "http://farm9.static.flickr.com/8179/8056992162_af4992a032.jpg",
name: "maria"
...
this.$.thumbnail.setSrc(r.img), this.$.title.setContent(r.name || "Untitled");
}
});
...
enyo.kind({
name: "com.particles4dev.Layout.Following",
classes: "menu-left ",
layoutKind: "FittableRowsLayout",
components: [ {
kind: "onyx.Toolbar",
...
data: [ {
img: "http://kendo-labs.github.com/angular-kendo/directive-sample/css/img/angular-kendo.png",
name: "maria"
}, {
img: "http://kendo-labs.github.com/angular-kendo/directive-sample/css/img/angular-kendo.png",
name: "maria"
...
enyo.kind({
name: "com.particles4dev.Layout.MainMenu",
listMenu: [ {
name: "Timeline",
"class": ""
}, {
...
name: "menu",
kind: "Repeater",
classes: "menu-frame raw",
count: 5,
onSetupItem: "setImageSource",
components: [ {
name: "tab",
classes: "tab",
components: [ {
...
indexMenuSelect: null,
setImageSource: function(e, t) {
var n = t.index, r = t.item;
return r.$.label.setContent(this.listMenu[n].name), n == 0 && (r.$.tab.addClass("select"), indexMenuSelect = r), !0;
},
changeMenuSelect: function(e) {
return indexMenuSelect.$.tab.removeClass("select"), indexMenuSelect = this.getMenu().children[e], indexMenuSelect.$.tab.addClass("select"), this;
},
selectMenu: function(e, t) {
var n = t.index;
indexMenuSelect.$.tab.removeClass("select"), e.addClass("select"), indexMenuSelect = e.parent;
var r = indexMenuSelect.$.label.content;
switch (r) {
case "Following":
this.owner.gotoPanel("following");
break;
case "Followers":
this.owner.gotoPanel("followers");
break;
default:
this.owner.parent.getBody().changePanel(n, r);
}
return !0;
},
search: function() {
var e = this.$.searchTerm.hasNode().value, t = new enyo.JsonpRequest({
...
if (!t) return;
this.owner.parent.getBody().addTweetsSearch(t).changePanel(5, "Search");
},
changeAvatar: function(e) {
this.$.avatar.setAttribute("src", e);
},
changeUsername: function(e) {
this.$.username.setContent(e);
},
logout: function() {
this.owner.owner.logoutMessage();
}
});
...
new enyo.kind({
name: "com.particles4dev.components.Tweets",
published: {
user_id: -1,
img: "assets/dynamic-toc.jpg",
title: "Automatic Table of Contents",
content: "content"
},
create: function() {
this.inherited(arguments), this.imgChanged(), this.titleChanged(), this.contentChanged();
},
imgChanged: function() {
this.$.img.setAttribute("src", this.img);
},
titleChanged: function() {
this.$.title.setContent(this.title);
},
...
selectTweet: function(e, t) {
console.log(e), console.log(t), console.log("user_id" + this.user_id);
}
});
...
enyo.kind({
name: "com.particles4dev.components.Picture",
kind: "Scroller",
touch: !0,
components: [ {
...
classes: "excerpt",
components: [ {
classes: "pic w320x240",
ontap: "pictureShow",
style: "background-image: url('http://s3.feedly.com/explore/tech.jpg' ); top: 0px; left:0px;",
components: [ {
classes: "title",
content: "Content"
} ]
}, {
classes: "pic w320x120",
style: "background-image: url('http://s3.feedly.com/explore/gaming.jpg' ); top: 0px; left:320px;",
components: [ {
classes: "title",
content: "Content"
} ]
...
classes: "pic w320x120",
style: "background-image: url('http://s3.feedly.com/explore/business.v2.jpg');top: 0px; left:640px;",
components: [ {
classes: "title",
content: "Content"
} ]
...
classes: "pic w320x120",
style: "background-image: url('http://s3.feedly.com/explore/design.jpg' );top: 120px; left:320px;",
components: [ {
classes: "title",
content: "Content"
} ]
}, {
classes: "pic w640x320",
style: "background-image: url('http://s3.feedly.com/explore/fashion.jpg' );top: 240px; left:0px;",
components: [ {
classes: "title",
content: "Content"
} ]
}, {
classes: "pic w320x440",
style: "background-image: url('http://www.ahorafondos.com/imagenes/shania-twain-021a/Shania-Twain-021a.jpg');top: 120px; left: 640px;",
components: [ {
classes: "title",
content: "Content"
} ]
...
components: [ {
classes: "pic w320x440",
style: "background-image: url('http://www.ahorafondos.com/imagenes/shania-twain-021a/Shania-Twain-021a.jpg');top: 0px; left: 0px;",
components: [ {
classes: "title",
content: "Content"
} ]
...
classes: "pic w640x320",
style: "background-image: url('http://s3.feedly.com/explore/fashion.jpg' );top: 120px; left:320px;",
components: [ {
classes: "title",
content: "Content"
} ]
...
classes: "pic w320x120",
style: "background-image: url('http://s3.feedly.com/explore/gaming.jpg' ); top: 440px; left:320px;",
components: [ {
classes: "title",
content: "Content"
} ]
...
classes: "pic w320x120",
style: "background-image: url('http://s3.feedly.com/explore/business.v2.jpg');top: 440px; left:640px;",
components: [ {
classes: "title",
content: "Content"
} ]
...
classes: "pic w320x120",
style: "background-image: url('http://s3.feedly.com/explore/design.jpg' );top: 440px; left:0px;",
components: [ {
classes: "title",
content: "Content"
} ]
...
onHide: "popupHidden",
scrim: !0,
style: "background: #4777b4;border-radius: 0px;min-width: 720px; min-height: 480px;",
components: [ {
classes: "pic",
style: "background-image: url('http://www.ahorafondos.com/imagenes/shania-twain-021a/Shania-Twain-021a.jpg'); width: 720px; height: 440px;",
components: [ {
classes: "title",
content: "Love"
} ]
...
return this.$.pictureShow.show(), this;
},
hidePictureShow: function() {
return this.$.pictureShow.hide(), this;
}
});
...
enyo.kind({
name: "com.particles4dev.Layout.MenuLeft",
layoutKind: "FittableRowsLayout",
classes: "",
components: [ {
classes: "menu-left",
...
components: [ {
name: "Login",
kind: "com.particles4dev.Layout.Login"
}, {
classes: "menu-left",
name: "panelMainMenu",
kind: "Panels",
...
components: [ {
name: "MainMenu",
kind: "com.particles4dev.Layout.MainMenu"
}, {
name: "Followers",
kind: "com.particles4dev.Layout.Followers"
}, {
name: "Following",
kind: "com.particles4dev.Layout.Following"
} ]
} ]
}, {
name: "loading",
...
kind: "onyx.Toolbar",
classes: "border-box toolbar-left hidden",
name: "ToolbarBottom",
style: "",
components: [ {
kind: "onyx.MenuDecorator",
...
switch (e) {
case "login":
this.$.panelMenuLeft.setIndex(0);
break;
case "main":
this.$.panelMainMenu.setIndex(0);
break;
case "followers":
this.$.panelMainMenu.setIndex(1);
break;
case "following":
this.$.panelMainMenu.setIndex(2);
break;
default:
}
return this;
...
gotoHome: function() {
return this.gotoPanel("main"), this;
},
showToolbar: function() {
return this.$.ToolbarBottom.removeClass("hidden"), this.showLoading().hideLoading().hideLoginPanel(), this.render(), this;
},
hiddenToolbar: function() {
return this.$.ToolbarBottom.addClass("hidden"), this.render(), this;
},
showLoading: function() {
return this.$.loading.setShowing(!0), this;
},
hideLoading: function() {
return this.$.loading.setShowing(!1), this;
},
showLoginPanel: function() {
return this.$.panelMenuLeft.setIndex(0), this;
},
hideLoginPanel: function() {
return this.$.panelMenuLeft.setIndex(1), this;
}
});
...
enyo.kind({
name: "com.particles4dev.Layout.Content",
classes: "content",
...
kind: "onyx.Toolbar",
classes: "header-bar",
style: "background-color: rgb(231, 231, 231); border-top: 1px solid #EFEFEC;",
components: [ {
kind: "onyx.Grabber"
}, {
name: "titlePanel",
...
name: "pageactionbar",
classes: "page-actionbar",
components: [ {
tag: "img",
src: "assets/icon-action-markasread.png"
}, {
tag: "img",
src: "assets/icon-action-refresh.png"
}, {
tag: "img",
src: "assets/icon-action-backtotop.png"
}, {
tag: "img",
src: "assets/icon-action-next.png"
} ]
} ]
}, {
kind: "Panels",
style: "height:86%;margin-top:20px;margin-left:16px;",
name: "samplePanels",
fit: !0,
draggable: !1,
...
style: "",
classes: "enyo-fit",
kind: "com.particles4dev.components.Picture"
}, {
content: 2,
style: ""
}, {
...
addTweetsSearch: function(e) {
return this.$.tweetListSearch.destroyClientControls(), enyo.forEach(e.results, this.addTweetSearch, this), this.$.tweetListSearch.render(), this;
},
addTweetSearch: function(e) {
return this.createComponent({
kind: com.particles4dev.components.Tweets,
container: this.$.tweetListSearch,
img: e.profile_image_url,
title: TWEET.ify.clean("@" + e.from_user),
content: TWEET.ify.clean(e.text),
user_id: e.from_user_id
}), this;
},
addTweets: function(e) {
return this.$.tweetList.destroyClientControls(), enyo.forEach(e, this.addTweet, this), this.$.tweetList.render(), this;
},
addTweet: function(e) {
return console.log(e), this.createComponent({
kind: com.particles4dev.components.Tweets,
container: this.$.tweetList,
img: e.user.profile_image_url,
title: TWEET.ify.clean("@" + e.user.screen_name),
content: TWEET.ify.clean(e.text),
user_id: e.from_user_id
}), this;
},
gotoPanel: function(e) {
return this.$.samplePanels.setIndex(e), this;
},
changeTitle: function(e) {
return this.$.titlePanel.setContent(e), this;
},
changePanel: function(e, t) {
return this.gotoPanel(e).changeTitle(t), this;
},
showLoading: function() {
return this.$.loading.setShowing(!0), this;
},
...
enyo.kind({
name: "com.particles4dev.FunBook",
kind: "FittableRows",
...
kind: "com.particles4dev.Layout.MenuLeft"
}, {
name: "body",
style: "background-color: #e7e7e7; background-clip: padding-box;border: solid transparent;border-width: 1px 1px 1px 6px;",
fit: !0,
classes: "panels-sample-sliding-content",
kind: "com.particles4dev.Layout.Content"
} ],
getBody: function() {
...
name: "data",
kind: "com.particles4dev.model.UserData"
}, {
name: "logoutPopup",
classes: "onyx-sample-popup",
kind: "onyx.Popup",
...
onHide: "popupHidden",
scrim: !0,
style: "background: #4777b4;border-radius: 0px;min-width: 300px;min-height: 150px;",
components: [ {
...
return this.$.logoutPopup.show(), this;
},
hideLogoutMessage: function() {
return this.$.logoutPopup.hide(), this;
},
doLogout: function() {
return this.$.logoutPopup.hide(), this.$.left.gotoPanel("login").hiddenToolbar(), this;
}
});
